  ...
  if( $testDuFormulaire === false) {
    echo "c'est faux";
     ...
     if(mysqli_query($connection,$sql)){
       ...
       echo '<a href ="poulets.php"><button type="button" class="btn btn-info"> Retour à la liste </button> </a>';
       echo '<a href ="adresses_poulets.php"><button type="button" class="btn btn-primary"> Ajout d\'une autre adresse </button> </a>';
    ...
    <br>
    <br>
    <form action="adresses_poulets.php" method="POST">
      race
      <div class="input-group">
      <span class="input-group-addon glyphicon glyphicon-user "></span>
      <input required name="race" type="text" class="form-control" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
      </div>
      <br>
      <br>
      id_ferme
